...
/* A tarefa consiste em Imprimir todos os elementos da árvore que estão entre os valores k e `.
...
void imprimirIntervalo(ArvoreNoCima* l,int a,int b){
    if(l== NULL){
        printf("Vazio");
    }
    else{
...
int main(){
    ArvoreNoCima* r=NULL;
    r=inserirNoCima(22,r);
    r=inserirNoCima(36,r);
    r=inserirNoCima(15,r);
    r=inserirNoCima(17,r);
    r=inserirNoCima(12,r);
    r=inserirNoCima(29,r);
    r=inserirNoCima(61,r);
    imprimir(r);
    printf("\n");
    imprimirIntervalo(r,15,25);
