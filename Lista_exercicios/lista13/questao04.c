...
/* A tarefa consiste em: Imprimir todas as folhas da árvore.
vamos fazer de forma recursiva
  Analise: a funçao que resolver essa questao é a imprimirTodasFolhas,
...
void imprimirTodasFolhas(ArvoreB* l){
    if (l==NULL){
        return;
    }
    ...
    imprimirTodasFolhas(l->esq);
    imprimirTodasFolhas(l->dir);
